  ...
  return (
    <section className="my-20 max-w-[1200px] mx-auto p-4 flex flex-col items-center w-full">
      <div className="flex gap-2 items-center my-8">
        ...
        <ReactSwitch onChange={toggleMonth} width={60} className="bg-gray-100 w-[60px]" checked = {type ==='monthly'} checkedIcon={false} onColor="#000" offColor="#DFDFDF"  onHandleColor="#fff" offHandleColor="#000"   uncheckedIcon={false} height={30} handleDiameter={20}  activeBoxShadow={null}/>
        ...
        {plansData.map((plan) => (
          <div
            className={`relative shadow-2xl w-full lg:flex-[33.33%] p-12  ${
              plan.title == "Pro"
                ? "!bg-black  !mt-0 lg:!h-[480px] after:w-full after:h-2 after:absolute  after:bg-borderImage after:top-0 md:after:w-2 md:after:h-full lg:after:w-full lg:after:h-2 shadow-custom"
                : ""
          ...
          >
            ...
            > 
              ${type === "monthly"? plan.yearly.toFixed(2) : plan.monthly.toFixed(2)}
