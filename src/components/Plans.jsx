  ...
  return (
    <section className="my-20 max-w-[1200px] mx-auto p-4">
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-8 items-center ">
        {plansData.map((plan) => (
          <div
            className={`relative w-full lg:w-[400px] p-12  ${
          ...
          >
            ...
            <button
              className={`${
                plan.title == "Pro" && "!bg-white !text-black"
              } bg-black uppercase text-sm font-bold tracking-[0.1em]  text-white mt-7 w-full p-4 py-2.5  md:col-start-1 md:col-end-2 md:row-start-3 md:row-end-4 lg:col-auto lg:row-auto `}
            >
              Pick Plan
            </button>
          </div>
