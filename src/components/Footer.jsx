  ...
  return (
    <footer className="bg-black text-white p-8 py-14  ">
      <div className="footerGrid">
        ...
        <nav className="navLinks ">
          <ul>
            <li>
              <Link
                to="/"
                className="border-2 border-transparent transition-all duration-300  hover:border-2 hover:border-b-white"
              >
                {" "}
                Home
              </Link>
        ...
        <div className="md:col-start-3 md:ml-auto text-right  text-gray-300">
          <p className="mb-3">Copyright {new Date().getFullYear()}. All Rights Reserved</p>
          <p>
            Challenge by
